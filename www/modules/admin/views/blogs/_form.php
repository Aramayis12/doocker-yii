...
<div class="blogs-form">
    ...
    <?php
		if (!$model->public_date) {
			$model->public_date = date('Y-m-d');
		}

		echo $form->field($model, 'public_date')->textInput([
      'placeholder' => 'Օրինակ՝ 2019-05-04'
    ]);
	?>
    ...
    <?php
  		if ($model->cover_image) {
  			echo '<p>' . Html::img(Yii::getAlias('@web/uploads/blog')  . '/' . $model->id . '/' . $model->cover_image, ['width'=>'340px']) . '<p>';
  		}
  	?>
