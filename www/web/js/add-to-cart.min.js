        ...
        t.preventDefault(), o.block({
            ...
            if(t.result){
                o.fadeOut( 1000, function() {
                    ...
                    $('.sc_layouts_cart_items_short').text($(".woocommerce-mini-cart-item").length);

                    if($(".woocommerce-mini-cart-item").length == 0){
                        $('.widget_shopping_cart_content').html('<p class="woocommerce-mini-cart__empty-message">Ձեր զամբյուղը դատարկ է:</p>');
                    }
                });
            } else {
